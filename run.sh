...
python main.py -t_step 50 --batchsize 128 --n_epoch 10 --model RNN --num_workers 16 --Sanity # --TEST
python main.py -t_step 50 --batchsize 128 --n_epoch 10 --model RNN --num_workers 0 --challenge_data ./test_samples/input
